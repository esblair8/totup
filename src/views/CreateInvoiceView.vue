    ...
    <div class="invoice" v-if="loggedInUser">
      ...
      <div class="bill-section columns is-vcentered">
        <div class="bill-to column is-half">
          ...
          <input
            class="input is-clickable is-small"
            v-model="initialInvoiceData.customerPostCode"
          />
          <input class="input is-clickable is-small" v-model="initialInvoiceData.customerCountry" />
          <input
            class="input is-clickable is-small"
            v-model="initialInvoiceData.customerEmailAddress"
          />
        </div>
      ...
      <div class="button-section">
        <button class="button is-small is-primary" @click="addLineItem">
          Add Another Line Item
        </button>
        <button class="button is-small is-warning ml-3" @click="removeLineItem">
          Remove Line Item
        </button>
      </div>
      ...
      <div class="notes-section">
        ...
        <textarea
          class="textarea has-fixed-size is-clickable"
          rows="3"
          v-model="initialInvoiceData.notes"
        ></textarea>
      </div>
      ...
      <div class="terms-section">
        ...
        <textarea
          class="textarea has-fixed-size is-clickable"
          rows="3"
          v-model="initialInvoiceData.terms"
        ></textarea>
      </div>
